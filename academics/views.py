...
from .models import AdmissionApplication,Student,Exam, Mark, Student, Subject ,QuestionPaper,Homework,HomeworkSubmission
...
def teacher_enter_marks(request):
    ...
    if filter_student:
        ...
        saved_marks = Mark.objects.all().select_related(
